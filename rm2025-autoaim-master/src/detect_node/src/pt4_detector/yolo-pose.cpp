...
YoloPoseDetector::Run(const cv::Mat &frame, bool enable_debug_show) {
...
// yolo模型初始化
void YoloPoseDetector::InitModule() {
...
// 预处理
void YoloPoseDetector::PreProcessImg(const cv::Mat &frame) {
...
std::vector<YoloPoseDetector::Armor>
YoloPoseDetector::PostPrecessImg(float *detections, ov::Shape &output_shape,
