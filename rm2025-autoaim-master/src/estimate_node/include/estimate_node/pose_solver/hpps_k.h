...
#ifndef RM2024_AUTOAIM_HPPS_K_H
#define RM2024_AUTOAIM_HPPS_K_H
#include <optional>
...
class HPPSK {
   ...
   private:
    ...
    [[nodiscard]] std::optional<double> Trichotomy(double imu_yaw,
                                                   double imu_pitch,
                                                   double imu_roll,
    ...
    [[nodiscard]] std::vector<cv::Point2f> Reprojection(const double armor_yaw,
