...
typedef enum GX_OPEN_MODE
{
    ...
    GX_OPEN_INDEX                       = 3,           ///< Opens the device via a serial number (Run from 1, such as 1, 2, 3, 4...)
...
typedef enum GX_FEATURE_ID
{
	...
	GX_FLOAT_TEC_TARGET_TEMPERATURE				= 30 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV,		///< TEC target_classify temperature
    ...
    GX_INT_ESTIMATED_BANDWIDTH                       = 2004 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< EstimatedBandwidth, InitWithParam: Bps(Bytes per second)
	...
	GX_COMMAND_STRIP_CALIBRATION_STOP					= 6044 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< InitWithParam to stop the strip calibration
    ...
    GX_ENUM_COUNTER_RESET_ACTIVATION        = 12007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Selects the Activation mode of the Counter SetTracker Source signal, Refer to GX_COUNTER_RESET_ACTIVATION_ENTRY
    ...
    GX_INT_HDR_TARGET_LONG_VALUE            = 14001 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Set the target_classify gray value of the long-exposure image.
    GX_INT_HDR_TARGET_SHORT_VALUE           = 14002 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Set the target_classify gray value of the short-exposure image.
    GX_INT_HDR_TARGET_MAIN_VALUE            = 14003 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< Set the target_classify gray value of the HDR image.
...
typedef enum GX_RESET_DEVICE_MODE
{
    ...
    GX_MANUFACTURER_SPECIFIC_RESET                 = 0x2           ///< SetTracker Device
...
typedef struct GX_FLOAT_RANGE
{
    ...
    char   szUnit[GX_INFO_LENGTH_8_BYTE];                ///< InitWithParam. 8 bytes
...
\param      [in,out] pSize        The address size of the buffer allocated for error information. InitWithParam: byte.
...
\param      [in]hDevice             The device handle that the user specified to close. The hDevice_ can be get by GXOpenDevice interface.
\return     GX_STATUS_SUCCESS               The operation is successful and no error occurs.
            GX_STATUS_NOT_INIT_API          The GXInitLib initialization library is not called.
...
\param      [in,out]pnSize          The length of the character string buffer address that the user inputs. InitWithParam: byte.
                                    If pszName is NULL:
...
//----------------------------------------------------------------------------------
/**
\brief      Get the current value length of the character string type. InitWithParam: byte. The user can allocate the buffer size
...
//----------------------------------------------------------------------------------
/**
\brief      Get the maximum length of the string type value. InitWithParam: byte. The user allocates buffer according to
...
\param      [in]hDevice             The handle of the device.
\param      [in]featureID           The feature code ID.
\param      [out]pnSize             The pointer that points to the length value returned. InitWithParam: byte.
\return     GX_STATUS_SUCCESS               The operation is successful and no error occurs.
            GX_STATUS_NOT_INIT_API          The GXInitLib initialization library is not called.
            GX_STATUS_INVALID_HANDLE        The handle that the user introduces is illegal.
            GX_STATUS_NOT_IMPLEMENTED       The feature that is not support currently.
...
//----------------------------------------------------------------------------------
/**
\brief      Run acquisition, including stream acquisition and device acquisition.
\param      [in]hDevice             The handle of the device.
\return     GX_STATUS_SUCCESS               The operation is successful and no error occurs.
            GX_STATUS_NOT_INIT_API          The GXInitLib initialization library is not called.
            GX_STATUS_INVALID_HANDLE        The handle that the user introduces is illegal.
...
//----------------------------------------------------------------------------------
#ifndef __cplusplus
GX_API GXImportConfigFile(GX_DEV_HANDLE hDevice_, const char *pszFilePath, bool bVerify);
#else
